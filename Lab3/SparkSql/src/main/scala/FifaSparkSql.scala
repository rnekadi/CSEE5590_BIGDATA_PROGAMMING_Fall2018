...
object FifaSparkSql {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val wc_df = spark.read
      ...
      .load("/Users/sai/Documents/GitHub/CSEE5590_BIGDATA_PROGAMMING_Fall2018/Lab3" +
                   "/data/WorldCups.csv")
    ...
    val csv = sc.textFile("/Users/sai/Documents/GitHub/CSEE5590_BIGDATA_PROGAMMING_Fall2018/Lab3" +
                                 "/data/WorldCups.csv")
